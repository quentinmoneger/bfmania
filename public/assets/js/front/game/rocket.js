...
function draw() {
  ...
  if (start) {
    ...
    ctx.fillText("Rocket.io", c.width / 2, c.height / 4);
    ctx.beginPath();
    ctx.fillStyle = "white";
    ctx.textBaseline = "middle";
    ctx.textAlign = "center";
    ...
    ctx.textAlign = "center";
    ctx.font = x / 12 + "px monospace";
    ctx.fillText(Date.now() % 2000 < 1000 ? "-Tap to restart-" : "-Try again-", c.width / 2, c.height / 2);
  } else {
    changeColor();
...
//# sourceURL=pen.js  //Thanks Dani, for the inspiration.