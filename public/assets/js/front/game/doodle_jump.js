...
function preload() {
  ...
  backgroundImg = loadImage("/assets/js/front/game/assets/doodle_jump/1024px-Graph-paper.svg.png");
  doodlerLeftImg = loadImage("/assets/js/front/game/assets/doodle_jump/doodle-jump-doodler.png");
  doodlerRightImg = loadImage("/assets/js/front/game/assets/doodle_jump/doodle-jump-doodler-right.png");
  platformImg = loadImage("/assets/js/front/game/assets/doodle_jump/doodle-jump-platform.png");
}
