...
/*
Tilt It! GAMEBOY VERSION
*/

var canva = document.querySelector('#container-canvas')
...
class Labirynthe {
  ...
  creerContexte() {
    ...
    document.querySelector('#container-canvas').appendChild(this.toile);
    // curseur
    this.curseur.efCorps = document.createElement("div");
    this.curseur.efCorps.className = "enfonceMarque";
    canva.appendChild(this.curseur.efCorps);
    this.curseur.distCorps = document.createElement("div");
    this.curseur.distCorps.className = "enfonceDist";
    canva.appendChild(this.curseur.distCorps);
    //controles
    canva.addEventListener("mousemove", event => this.curseurActif(event), false);
    canva.addEventListener("mousedown", event => this.curseurEnfonce(event), false);
    canva.addEventListener("mouseup", event => this.curseurLeve(event), false);
  }
  curseurEnfonce(e) {
      ...
      switch (action) {
        case "mort":
          ...
          if(this.life < 1){
            ...
            this.ctx.textAlign = "center";
            this.ctx.font = "20px Arial";
            this.ctx.fillText("GAME OVER !!!", this.L / 2, this.H / 2 - 40); 
        ...
        case "suivant":
          ...
          if (this.niveauActuel < this.niveaux.length) {
            ...
            this.ctx.fillText("Your score : " + this.score, this.L / 2, this.H / 2 + 20);
            this.ctx.font = "12px Arial";
            this.ctx.fillText("Follow me", this.L / 2, this.H - 20);
          }
          break;
        case "point":
